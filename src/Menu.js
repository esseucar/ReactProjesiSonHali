...
//TEKRAR KULLANILABİLİR DEĞERLER
    const baslik = ["Bengal", "Mavi Rus", "Van", "Tekir", "Yeni Kedi"];
    const Menu_eleman=["Eğitimler","Hemen Başvur","s.s.s.","Hakkımızda"];
    const basliklar= ["Yüzyüze verilecek olan eğitimler"]
    const egitim=["450 saat akademik eğitim 50 saat kariyer eğitimi olmak üzere toplam 500 saat eğitim verilmektedir Eğitimler 20 kişilik sınıflarda sabah ve akşam grubu şeklinde günde 7 saat toplamda 72 gün sürmektedir."]
